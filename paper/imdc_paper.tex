...
horizon-dependent: it is the strongest of the four models stratified here at short lead times (normalized WIS 0.255 at 16 to 27 weeks, bettered only by its pinball-trained variant at 0.227, Section~ef{sec:extended})
...
outputs. Among the models in Table~ef{tab:operational}, the gradient-boosted model (XGBoost) has the lowest onset-timing error (3.7 weeks mean
absolute
