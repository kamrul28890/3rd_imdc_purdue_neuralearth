...
concentrated in a subset of states (Ceara and Rio de Janeiro most strongly) rather than uniform, and
the gradient-boosted model is the only one of the six with states that are red, meaning worse than
the seasonal-naive baseline (Amapa, Paraiba, Pernambuco), which the state-level aggregate in
