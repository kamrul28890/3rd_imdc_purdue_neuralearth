...
reproducibility statement (S7), per-state model performance (S8), and a glossary of the technical
terms used in the main text (S9). All numbers correspond to the committed backtest and are
reproducible from the released pipeline.
