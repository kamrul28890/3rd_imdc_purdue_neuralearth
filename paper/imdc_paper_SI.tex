...
is worse, and the diverging scale is centred on baseline parity. A red-blue scale is used rather
than red-green so that the comparison remains readable under red-green colour vision deficiency
and in greyscale. The underlying values are released as
